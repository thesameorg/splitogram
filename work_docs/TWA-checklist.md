...
- [ ] Если приложение обрабатывает данные нестандартным образом — зарегистрирована кастомная Privacy Policy через @BotFather
- [ ] Политика доступна пользователям на странице Settings бота
- [ ] Соблюдаются все применимые законы о защите данных (GDPR и пр.)

### 5.2 Terms of Service

- [ ] Подготовлены базовые Terms of Use — даже если сохраняете только юзернеймы
