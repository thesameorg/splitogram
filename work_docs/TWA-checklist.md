...
- [x] Подключение кошельков — через **TON Connect SDK** _(Phase 10)_
...
- [x] Приложение **полностью готово** — "почти готовые" приложения отклоняют
- [x] Бот отвечает на `/start` **на английском** по умолчанию
- [x] Подключён **@DataChief_bot** (Telegram Mini Apps SDK аналитика) — должен показывать свежие записи
