...
### UpdateCommission
TL-B: `update_commission#e3de68f1 new_commission:uint16 = UpdateCommission`
Signature: `UpdateCommission{new_commission:uint16}`
...
### Stats
TL-B: `_ total_processed:coins total_commission:coins settlement_count:uint32 = Stats`
Signature: `Stats{total_processed:coins,total_commission:coins,settlement_count:uint32}`

### SplitogramSettlement$Data
TL-B: `_ owner:address commission_bps:uint16 usdt_wallet:address total_processed:coins total_commission:coins settlement_count:uint32 = SplitogramSettlement`
Signature: `SplitogramSettlement{owner:address,commission_bps:uint16,usdt_wallet:address,total_processed:coins,total_commission:coins,settlement_count:uint32}`
...
```mermaid
graph TD
SplitogramSettlement
SplitogramSettlement --> BaseTrait
SplitogramSettlement --> Deployable
Deployable --> BaseTrait
SplitogramSettlement --> Ownable
Ownable --> BaseTrait
```
